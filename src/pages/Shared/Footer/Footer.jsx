            ...
            <Container>
                <div className='footer-er-kaj'>
                    ...
                    <div className='footer-box-2 ps-5 '>
                        ...
                        <p className='footer-lines'> <small><FaAt></FaAt> LaItalia@gmail.com <br />
                            <FaMobileAlt></FaMobileAlt> 011xxxxxxx <br />
                            <GoLocation></GoLocation> Plata a Plomo, Milan, Italy </small>
                        </p>
                    </div>
                </div>
